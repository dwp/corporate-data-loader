...
class TextUtils {
    ...
    private val qualifiedTablePattern = Regex(CorporateMemoryConfiguration.qualifiedTablePattern)
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(TextUtils::class.java.toString())
    }
